...
class Attendace:
    def __init__(self,root):
        ...
        # myname=Label(self.root,text="Developed By:Priyanka",fg="white",bg="black",font=("times new roman",18,"bold"))
    ...
    def fetch_data(self):
        conn=mysql.connector.connect(host="localhost",username="root",password="1234",database="facial_recognition")
    ...
    def export_data(self):
        try:
            ...
            with open (fln,mode="w",newline="") as myfile:
                ...
                messagebox.showinfo("Data Exported","Your data has been exported to " +os.path.basename(fln)+ " Successfully!",parent=self.root)
