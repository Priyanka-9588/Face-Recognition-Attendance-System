...
class Developer:
    def __init__(self,root):
        ...
        support=Label(Manage_std_frame1,bg="black",fg="yellow",text="Priyanka",font=("times new roman",22,"bold"))
        support.place(x=10,y=45)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="I am a second year B.Tech. Computer Engineering",font=("arial",12,"bold"))
        support.place(x=10,y=110)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="with specialization in Data Science student with experience in",font=("arial",12,"bold"))
        support.place(x=10,y=140)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="programming languages like Python, Java & C.",font=("arial",12,"bold"))
